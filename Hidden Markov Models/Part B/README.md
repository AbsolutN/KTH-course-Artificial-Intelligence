In this task, I calculate the probability to observe a certain emission sequence given a HMM model. I was given the HMM model and a sequence of observations (aka emissions, events, etc) and the task was to calculate the probability for this sequence.
...
**Output:**
The probability of the given sequence as a single scalar.
